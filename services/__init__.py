...
_EXPORTS = {
    ...
    "TranscriptionModelSpec": (".model_service", "TranscriptionModelSpec"),
    "detect_language": (".model_service", "detect_language"),
    "detect_runtime": (".model_service", "detect_runtime"),
    "is_experimental_model": (".model_service", "is_experimental_model"),
    "load_model": (".model_service", "load_model"),
    "model_supports_diarization": (".model_service", "model_supports_diarization"),
    ...
    "LiveAudioDevice": (".live_transcription_service", "LiveAudioDevice"),
    "LiveSessionOptions": (".live_transcription_service", "LiveSessionOptions"),
    "LiveSessionSnapshot": (".live_transcription_service", "LiveSessionSnapshot"),
    "LiveSessionController": (".live_transcription_service", "LiveSessionController"),
    "audio_format_to_dict": (".live_transcription_service", "audio_format_to_dict"),
    "build_live_capture_format": (".live_transcription_service", "build_live_capture_format"),
    "choose_live_audio_devices": (".live_transcription_service", "choose_live_audio_devices"),
    "classify_live_audio_device": (".live_transcription_service", "classify_live_audio_device"),
    "default_live_output_dir": (".live_transcription_service", "default_live_output_dir"),
    "list_live_audio_inputs": (".live_transcription_service", "list_live_audio_inputs"),
    "live_model_supported": (".live_transcription_service", "live_model_supported"),
    "normalize_live_pcm_chunk": (".live_transcription_service", "normalize_live_pcm_chunk"),
    "reconcile_live_transcript": (".live_transcription_service", "reconcile_live_transcript"),
    "GpuMemoryInfo": (".live_vram_service", "GpuMemoryInfo"),
    "LiveVramPreflight": (".live_vram_service", "LiveVramPreflight"),
    "assess_live_vram_preflight": (".live_vram_service", "assess_live_vram_preflight"),
    "estimate_live_model_vram_gb": (".live_vram_service", "estimate_live_model_vram_gb"),
    "get_gpu_memory_info": (".live_vram_service", "get_gpu_memory_info"),
    "recommend_model": (".model_service", "recommend_model"),
    "resolve_transcription_model": (".model_service", "resolve_transcription_model"),
